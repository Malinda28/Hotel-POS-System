...
//	public $layout='//layouts/column2';
	...
	{
		return array(
			//array('nic_no', 'unique', 'message' => "Phone number already exists."),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Customer']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->nic_no));
		}
	...
	{
		$searchmodel=new Customer('search');
		$model=$this->loadModel($id);
		...
		if(isset($_POST['Customer']))
		{
			...
			Yii::app()->user->setFlash('success', "<script>
													window.onload = function gos()
													{
														...
														document.getElementById('message-body').innerHTML= 'Customer successfully updated !!' ;
														$('#myModal').modal('show');
