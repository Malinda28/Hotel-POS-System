...
<style>#Restaurant_items_category{
    ...
    border: 1px solid #ccc;
	    ...
	    #Regular_row{margin-bottom: 10px;}</style>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="row" id="Regular_row">
						...
						<div class="col-xs-6">
							<div class="input-group">
								<input type="number" class="form-control input-sm" placeholder="Enter Large Qty" id="Lqty">
        ...
        <div class="modal-footer" >
          <button type="button" class="btn btn-success" data-dismiss="modal" onclick="listIngredients()">Add as Ingredient</button>
        </div>
      </div>
   </div>
 </div>
...
window.onload = function cheklist(){
	...
	//if (typeof document.getElementById("Rqty").value; == "undefined" || sessionvalue == null)
	//alert(QtyL);
	var customObjects = {};
