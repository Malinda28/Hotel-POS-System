...
class ReservationDetail extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('reservation_id, room_no, adults, children', 'required'),
			array('reservation_id, room_no, adults, children', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('detail_id, reservation_id, room_no, adults, children', 'safe', 'on'=>'search'),
		);
	}
