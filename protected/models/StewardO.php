...
class Steward extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('steward_id, Name, status', 'required'),
			array('Gender', 'required'),
			array('steward_id', 'numerical', 'integerOnly'=>true),
			array('steward_id', 'length', 'max'=>5),
			...
			array('steward_id, Name, Gender, availability', 'safe', 'on'=>'search'),
			array('steward_id', 'unique', 'message' => "Steward ID already exists."),
		);
